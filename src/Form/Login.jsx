    ...
    return  (
        <div>
            <form  onSubmit={loginHandler}>
                <input placeholder="UserName"  required onChange={(e)=>onChangeHandlerType(e, 'userName')} value = {loginData.userName}/>
                <input placeholder="Password"   required onChange={(e)=>onChangeHandlerType(e,'password')} value= {loginData.password}/>
